...
check "[ -x \"$stage$sbin/hping3\" ]" "hping3 installed in sbindir"
check "[ -L \"$stage$sbin/hping\" ]" "hping symlink"
check "[ -L \"$stage$sbin/hping2\" ]" "hping2 symlink"
check "[ \"\`readlink \"$stage$sbin/hping\"\`\" = hping3 ]" "hping symlink is relative"
check "[ -f \"$stage$man/man8/hping3.8\" ]" "man page installed"
check "\"$stage$sbin/hping3\" --version >/dev/null 2>&1" "installed binary runs (--version)"
...
check "[ ! -e \"$stage$sbin/hping3\" ]" "uninstall removed the binary"
check "[ ! -e \"$stage$man/man8/hping3.8\" ]" "uninstall removed the man page"
